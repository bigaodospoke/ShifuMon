...
object TypeColors {
    ...
    private val classic = mapOf(
        "normal" to 0x98986A, "fire" to 0xF08030, "water" to 0x6890F0, "electric" to 0xD8A800,
        "grass" to 0x68B840, "ice" to 0x58B8C8, "fighting" to 0xC03028, "poison" to 0xA040A0,
        "ground" to 0xC8A048, "flying" to 0x9880E0, "psychic" to 0xF85888, "bug" to 0x98A818,
        "rock" to 0xB8A038, "ghost" to 0x705898, "dragon" to 0x7038F8, "dark" to 0x705848,
